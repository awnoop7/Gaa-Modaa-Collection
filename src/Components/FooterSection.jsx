      ...
      <div className="container mx-auto px-4 text-center md:text-left grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div>
          ...
          <div className="mt-2 flex justify-center md:justify-start space-x-4">
            <a href="https://www.facebook.com/awn.oop.649702" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white text-lg"><FaFacebookF /></a>
            ...
            <a href="https://www.instagram.com/awn_oop/" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white text-lg"><FaInstagram /></a>
          </div>
        </div>
      </div>
